...
class Categoria_Estabelecimento{
    ...
    public static function ListarTudo(){
        ...
        $sql = "SELECT * FROM estabelec_categoria";
    ...
    public function Cadastrar(){
        $banco = Banco::conectar();
        $sql = "INSERT INTO estabelec_categoria(nome) VALUES(?)";        
    ...
    public function Editar(){
        $banco = Banco::conectar();
        $sql = "UPDATE estabelec_categoria SET nome=? WHERE id=?";
    ...
    public function Apagar(){
        $banco = Banco::conectar();
        $sql = "DELETE FROM estabelec_categoria WHERE id = ?";
        $banco->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $comando = $banco->prepare($sql);
        // Tratamento de erro:
        try{
